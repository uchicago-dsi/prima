    ...
    readme.write_text(
        "\n".join(
            [
                ...
                f"- seed: `{args.seed}`",
                "",
                "Sampling uses only the requested numeric ranking columns for enrichment",
                "plus a random control stratum. Ranking fields may be metadata-derived,",
                "but they are never treated as reference labels or eligibility filters.",
