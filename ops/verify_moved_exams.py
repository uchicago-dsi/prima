...
Examples:
  python3 ops/verify_moved_exams.py
  python3 ops/verify_moved_exams.py --snapshot-date 2025.10.11-03.04.09
        """,
    )
    ...
    if missing_not_in_modality:
        ...
        logger.error(
            "These exams need to be recovered from snapshot using ops/recover_from_snapshot.py"
        )
        sys.exit(1)
