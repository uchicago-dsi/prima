...
Usage:
    python ops/reorganize_by_modality.py --raw /path/to/data --dry-run
    python ops/reorganize_by_modality.py --raw /path/to/data --resume
"""
...
Examples:
  ...
  python ops/reorganize_by_modality.py --raw /gpfs/data/huo-lab/Image/ChiMEC/ --dry-run

  # Actually perform the reorganization and cleanup empty dirs
  python ops/reorganize_by_modality.py --raw /gpfs/data/huo-lab/Image/ChiMEC/

  # Resume interrupted run
  python ops/reorganize_by_modality.py --raw /gpfs/data/huo-lab/Image/ChiMEC/ --resume

  # Process only first 50 exams (for testing)
  python ops/reorganize_by_modality.py --raw /gpfs/data/huo-lab/Image/ChiMEC/ --max-exams 50
        """,
    )
