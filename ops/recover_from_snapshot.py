...
Examples:
  ...
  python3 ops/recover_from_snapshot.py --dry-run

  # Actually perform the recovery
  python3 ops/recover_from_snapshot.py

  # Use custom snapshot date
  python3 ops/recover_from_snapshot.py --snapshot-date 2025.10.11-03.04.09
        """,
    )
